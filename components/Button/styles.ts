const buttonStyles = {
  ...
  element: "flex text-black flex-1 justify-between flex-wrap border-none text-xs md:text-lg font-semibold items-center bg-orange-100 hover:bg-orange-shade transition-colors duration-200 py-2 px-5 rounded-full",
